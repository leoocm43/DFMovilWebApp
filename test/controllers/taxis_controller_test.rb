...
class TaxisControllerTest < ActionController::TestCase
  ...
  test "should create taxi" do
    assert_difference('Taxi.count') do
      post :create, taxi: { latitud: @taxi.latitud, longitud: @taxi.longitud, nombreBase: @taxi.nombreBase, nombreTitular: @taxi.nombreTitular }
    end
  ...
  test "should update taxi" do
    patch :update, id: @taxi, taxi: { latitud: @taxi.latitud, longitud: @taxi.longitud, nombreBase: @taxi.nombreBase, nombreTitular: @taxi.nombreTitular }
    assert_redirected_to taxi_path(assigns(:taxi))
  end
