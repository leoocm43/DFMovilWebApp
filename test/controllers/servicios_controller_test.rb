...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { latitud: @servicio.latitud, longitud: @servicio.longitud, organismo: @servicio.organismo, parada: @servicio.parada, ruta: @servicio.ruta }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { latitud: @servicio.latitud, longitud: @servicio.longitud, organismo: @servicio.organismo, parada: @servicio.parada, ruta: @servicio.ruta }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
